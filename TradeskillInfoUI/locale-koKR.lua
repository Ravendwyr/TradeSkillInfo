...
L["Source"] = "출처"
L["Show source in tooltip"] = "출처를 툴팀에 표시합니다."
L["Used in"] = "사용처"
L["Show used in in tooltip"] = "사용처를 툴팀에 표시합니다."
L["Usable by"] = "사용 가능"
...
L["ItemID"] = "아이템 ID"
L["Show ItemID in tooltip"] = "아이템 ID를 툴팁에 표시합니다."
L["Stack Size"] = "겹침"
L["Show item stack size in tooltip"] = "겹칠 수 있는 아이템수를 툴팁에 표시합니다."
L["Recipe Source"] = "제조법 출처"
L["Show source in tooltip"] = "제조법의 출처를 툴팁에 표시합니다."
L["Recipe Price"] = "제조법 판매가격"
L["Show vendor sell price in tooltip"] = "상인의 판매가를 툴팁에 표시합니다."
L["Show known by in recipe tooltip"] = "제조법을 이미 배운 케릭들을 표시합니다."
L["Show learnable by in recipe tooltip"] = "현재 배움 가능한 케릭들을 툴팁에 표시합니다."
L["Show will be learnable by in recipe tooltip"] = "추후 배움이 가능한 케릭들을 툴팁에 표시합니다."
L["Skill required"] = "필요한 숙련치"
L["Show skill required"] = "필요한 숙련치를 툴팁에 표시합니다."
L["Combine cost"] = "제작 비용"
L["Show combine cost"] = "제작 비용을 툴팁에 표시합니다."
L["Trainer reagents"] = "트레이너 재료표시"
...
L["LeftButton"] = "왼쪽 버튼"
L["RightButton"] = "오른쪽 버튼"
L["Search Shift Key"] = "빠른검색 기능키 설정"
L["Shift key to be held down for quick search"] = "빠른 검색시 사용할 기능키를 지정합니다."
L["Frame Strata"] = "프레임 위치"
L["Set TradeskillInfoUI frame strata"] = "TradeskillInfoUI창의 프레임 위치를 셋팅 합니다."
L["LOW"] = "낮음"
L["MEDIUM"] = "중간"
L["HIGH"] = "높음"
L["Item Tooltip"] = "아이템 툴팁"
L["Recipe Tooltip"] = "제조법 툴팁"
L["TradeSkill Frame"] = "전문기술 창"
L["Trainer Frame"] = "보조기술 창"
L["Quick Search"] = "빠른 검색"
L["Auction House"] = "경배장"
...
L["Auction"] = "경매"
L["OK"] = "OK"
L["Tradeskill Info Config"] = "Tradeskill Info 설정"
L["UI Scale"] = "UI Scale"
L["Change scale of user interface"] = "사용자 interface의 크기로 바꿈"
