...
L["Show what tradeskill an item is used in in it's tooltip"] = "Показывает в подсказке, в каком ремисле используется предмет"
...
L["Show who can learn a recipe in it's tooltip"] = "Показывает в подсказке, кто может выучить данному рицепту"
...
L["Unknown source. Please report it. Source="] = "Unknown source. Пожалуйста, сообщите об этом. Источник="
