...
L["Complete Tradeskill Info"] = "Complete Tradeskill Info"
L["Source"] = "Источник"
L["Vendor sell price"] = "Продажная цена"
L["ItemID"] = "ID предмета"
L["Stack size"] = "Размер стака"
L["Combine profit"] = "объединять полезность"
L["Show cost of combine and profit"] = "Показывать общую стоимость и полезность"
L["Combine level"] = "объединять уровень"
L["Show skill level of the combines"] = "Показывать уровень мастерства и объединять его"
L["Show the source of the item"] = "Показывать источники предмета"
L["Used in"] = "Используемый в"
L["Show what tradeskill an item is used in in it's tooltip"] = "Показывает в подсказке, в каком ремесле используется предмет"
L["Usable by"] = "Использует"
L["Show who can use an item in it's tooltip"] = "Показывает в подсказке, кто может использовать данный предмет"
L["Known by"] = "Уже известен"
L["Show who knows a recipe in it's tooltip"] = "Показывает в подсказке, кто уже знает данный рецепт"
L["Learnable by"] = "Изучается у"
L["Show who can learn a recipe in it's tooltip"] = "Показывает в подсказке, кто может выучить данный рецепт"
L["Will be able to learn"] = "Доступен для изучения"
L["Show who will be able to learn a recipe in it's tooltip"] = "Показывает в подсказке, кто может изучить рецепт"
L["Reagents"] = "Регенты"
L["Show what reagents a recipe takes at the trainer"] = "Показывает какие реагенты покупаются у тренеров"
L["Config"] = "Настройка"
L["Show config screen"] = "Открывает окно настроек"
L["Menu"] = "Меню"
L["Show TradeskillInfo UI"] = "Показать TradeskillInfo UI"
L["Banked"] = "В банке"
...
L["Unknown source. Please report it. Source="] = "Неизвестный источник. Пожалуйста, сообщите об этом. Источник="
...
L["Khole Jinglepocket"] = true -- Smokywood Pastures
...
L["Seersa Copperpinch"] = true -- Smokywood Pastures
...
L["Wrahk"] = "Ракх"
L["Wulan"] = "Вулан"
L["Wulmort Jinglepocket"] = true -- Smokywood Pastures
...
L["Combine profit from auctioneer advanced"] = "Combine profit from auctioneer advanced"
L["Show cost of combine and profit from auctioneer advanced"] = "Show cost of combine and profit from auctioneer advanced"
L["Market Value"] = "Market Value"
L["Auctioneer Market Value Profit"] = "Auctioneer Market Value Profit"
